...
var (
	...
	TriesVerifyModeFlag = TextMarshalerFlag{
		...
		Usage: `tries verify mode: "local: a normal full node", "full: state verification by verify node, full secure mode", "insecure: state verification by verify node but insecure mode", "none: no state verification"`,
